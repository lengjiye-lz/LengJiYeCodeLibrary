...
public class MvpDelegate<V extends MvpView, P extends MvpPresenter<V>> {
    ...
    private P createaPresenter() {
        ...
        if (presenter == null) {
            LogTool.e("Presenter return from createaPresenter() is null");
        }
    ...
    private P getPresenter() {
        ...
        if (presenter == null) {
            LogTool.e("Presenter returned from getPresenter() is null");
        }
        return presenter;
    }
    ...
    private V getMvpView() {
        ...
        if (view == null) {
            LogTool.e("View returned from getMvpView() is null");
        }
        return view;
    }
